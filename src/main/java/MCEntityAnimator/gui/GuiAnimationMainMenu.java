...
public class GuiAnimationMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, this.mceaSplashText, 0, -8, -256);
        GL11.glPopMatrix();
