...
public class GuiAnimationSequenceMain extends GuiScreen 
{
	int posX;
	int posY;
	...
	public GuiAnimationSequenceMain(String par0Str)
	{
	...
	{	
		switch(button.id)
		{
		case 0: mc.displayGuiScreen(new GuiAnimationSequenceNew(entityName)); break;
		case 1: mc.displayGuiScreen(new GuiAnimationSequenceList(entityName, AnimationData.getSequences(entityName))); break;
		case 2: break;
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		this.drawCenteredString(this.fontRendererObj, "Sequences", posX + 40, posY + 6, 0xffff0000);
