...
public class GuiAnimationTimelineWithFrames extends GuiScreen
{
	...
	private String currentPartName, additionalHighlightPartName;
	...
	private int scaleModifier = 0, horizontalPan = 0,verticalPan = 0;
